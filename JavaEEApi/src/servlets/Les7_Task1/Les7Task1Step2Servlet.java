...
@WebServlet(value = "/les7Task1Step2")
public class Les7Task1Step2Servlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Les7Task1/task1Step2.jsp").forward(request, response);
    }
